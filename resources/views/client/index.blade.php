...
<![endif]-->
    <meta name="description"
        content="Glorious is a creative, clean, fully responsive, powerful and multipurpose HTML Template with latest website trends. Perfect to all type of fashion stores.">
    ...
    <title>Glorious - Multipurpose Online Marketplace HTML Template</title>

    <!-- Favicons Icon -->
    <link rel="icon" href="/assets/client/images/favicon.ico" type="image/x-icon" />

    <!-- Mobile Specific -->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <!-- CSS Style -->
    <link rel="stylesheet" type="text/css" href="/assets/client/css/styles.css" media="all">
</head>
...
<body class="cms-index-index cms-home-page">
        ...
        <ul>
            ...
            <li><a href="index.html">Home</a>
                <ul>
                    ...
                    <li><a href="index.html">Home Shop 4</a></li>
                </ul>
            </li>
            <li><a href="#">Pages</a>
                <ul>
    ...
    <div id="page">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-3 col-xs-12">
                            <div class="logo"><a title="ecommerce Template" href="index.html"><img
                                        alt="ecommerce Template" src="/assets/client/images/logo.png"></a></div>
                            <div class="nav-icon">
                                <div class="mega-container visible-lg visible-md visible-sm">
                                    <div class="navleft-container">
                                        ...
                                        <div class="mega-menu-category">
                                                ...
                                                <li><a href="#">Home</a>
                                                    <div class="wrap-popup column1">
                                                        <div class="popup">
                                                            <ul class="nav">
                                                                <li><a href="index.html">Home Shop 1</a></li>
                                                                <li><a href="version2/index.html">Home Shop 2</a>
                                                                </li>
                                                                <li><a href="version3/index.html">Home Shop 3</a>
                                                                </li>
                                                                <li><a href="index.html">Home Shop 4</a></li>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="wrap-popup">
                                                        <div class="popup">
                                                                    ...
                                                                    <div class="custom-menu-right">
                                                                        <div class="box-banner media">
                                                                            <div class="add-right"><a href="#"><img
                                                                                        src="/assets/client/images/jtv-menu-banner1.jpg"
                                                            ...
                                                            <a href="#" class="ads"><img
                                                                    src="/assets/client/images/jtv-menu-banner4.jpg"
                                                                    alt="Mega Sale" class="img-responsive"></a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li><a href="#">Women's</a>
                                                        ...
                                                        <div class="popup">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-sm-6 has-sep">
                                                                    ...
                                                                    <ul class="nav">
                                                                        <li><a href="shop-grid-sidebar.html">Make up</a>
                                                                        </li>
                                                                    ...
                                                                    <div class="custom-menu-right">
                                                                        <div class="box-banner media">
                                                                            ...
                                                                            <div class="add-right"><img
                                                                                    src="/assets/client/images/jtv-menu-banner2.jpg"
                                                                                    alt="Top Glass"
                                                                        ...
                                                                        <div class="box-banner media">
                                                                            ...
                                                                            <div class="add-right"><img
                                                                                    src="/assets/client/images/jtv-menu-banner3.jpg"
                                                                                    alt="Save 35%"
                                                                                    class="img-responsive"></div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="side-banner"><img src="/assets/client/images/top-banner.jpg"
                        ...
                        <div class="col-lg-9 col-sm-9 col-xs-12 jtv-rhs-header">
                            <div class="jtv-mob-toggle-wrap">
                                <div class="mm-toggle"><i class="fa fa-reorder"></i><span class="mm-label">Menu</span>
                                </div>
                            </div>
                                    ...
                                    <div class="search-box hidden-xs">
                                        <form id="search_mini_form" action="#" method="get">
                                            <select name="cat" id="cat"
                                                class="cate-dropdown hidden-xs hidden-sm hidden-md">
                                                                ...
                                                                <li class="item">
                                                                    <div class="item-inner"><a class="product-image"
                                                                            ...
                                                                            href="product-detail.html"><img
                                                                                ...
                                                                                src="/assets/client/images/products/product-fashion-1.jpg"></a>
                                ...
                                <div class="top_section hidden-xs">
                                    <div class="toplinks">
                                        ...
                                        <ul class="links">
                                            ...
                                            @if ($check == 1)
                                            <li><a title="Log Out" href="{{ route('logout') }}" onclick="event.preventDefault();
                                            ...
                                            @else
                                            <li><a title="Log In" href="{{ route('login') }}">Log In</a></li>
                                            @endif
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 jtv-main-home-slider">
                        ...
                        <div id='rev_slider_1' class='rev_slider fullwidthabanner'>
                            <ul>
                                <li data-transition='fade' data-slotamount='7' data-masterspeed='1000'
                                    data-thumb='/assets/client/images/slider/slide-img1.jpg'><img
                                        src='/assets/client/images/slider/slide-img1.jpg' alt="slider image1"
                                    ...
                                    <div class="info">
                                        <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-x='0'
                                            data-y='165' data-endspeed='500' data-speed='500' data-start='1100'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:2;white-space:nowrap;'><span>Shop The Trend</span></div>
                                        <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-x='0' data-y='220'
                                            data-endspeed='500' data-speed='500' data-start='1300'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:3;white-space:nowrap;'>Amazing Chance!</div>
                                        <div class='tp-caption Title sft  tp-resizeme ' data-x='0' data-y='300'
                                            data-endspeed='500' data-speed='500' data-start='1500'
                                            data-easing='Power2.easeInOut' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:4;white-space:nowrap;'>Our new arrivals can't wait to meet
                                            you.</div>
                                        <div class='tp-caption sfb  tp-resizeme ' data-x='0' data-y='350'
                                            data-endspeed='500' data-speed='500' data-start='1500'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:4;white-space:nowrap;'><a href='#' class="buy-btn">Browse
                                                Now</a></div>
                                    </div>
                                </li>
                                <li data-transition='fade' data-slotamount='7' data-masterspeed='1000'
                                    data-thumb='/assets/client/images/slider/slide-img3.jpg'><img
                                        src='/assets/client/images/slider/slide-img3.jpg' alt="slider image2"
                                        data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
                                    <div class="info">
                                        <div class='tp-caption ExtraLargeTitle sft slide2  tp-resizeme ' data-x='45'
                                            data-y='165' data-endspeed='500' data-speed='500' data-start='1100'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:2;white-space:nowrap;padding-right:0px'><span>Spring
                                                Fashion</span></div>
                                        <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-x='45' data-y='220'
                                            data-endspeed='500' data-speed='500' data-start='1300'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:3;white-space:nowrap;'>Be Summer Ready</div>
                                        <div class='tp-caption Title sft  tp-resizeme ' data-x='45' data-y='300'
                                            data-endspeed='500' data-speed='500' data-start='1500'
                                            data-easing='Power2.easeInOut' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:4;white-space:nowrap;'>Identify your Look, Define your Style!
                                        </div>
                                        <div class='tp-caption sfb  tp-resizeme ' data-x='45' data-y='350'
                                            data-endspeed='500' data-speed='500' data-start='1500'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:4;white-space:nowrap;'><a href='#' class="buy-btn">Join
                                                us</a></div>
                                    </div>
                                </li>
                                <li data-transition='fade' data-slotamount='7' data-masterspeed='1000'
                                    data-thumb='/assets/client/images/slider/slide-img2.jpg'><img
                                        src='/assets/client/images/slider/slide-img2.jpg' alt="slider image3"
                                        data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
                                    <div class="info">
                                        <div class='tp-caption ExtraLargeTitle sft slide2  tp-resizeme ' data-x='45'
                                            data-y='165' data-endspeed='500' data-speed='500' data-start='1100'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:2;white-space:nowrap;padding-right:0px'><span>Big Sale</span>
                                        </div>
                                        <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-x='45' data-y='220'
                                            data-endspeed='500' data-speed='500' data-start='1300'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:3;white-space:nowrap;'>New Fashion</div>
                                        <div class='tp-caption Title sft  tp-resizeme ' data-x='45' data-y='300'
                                            data-endspeed='500' data-speed='500' data-start='1500'
                                            data-easing='Power2.easeInOut' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                                            style='z-index:4;white-space:nowrap;'>Look great & feel amazing in our
                                            stunning dresses.</div>
                                        <div class='tp-caption sfb  tp-resizeme ' data-x='45' data-y='350'
                                            data-endspeed='500' data-speed='500' data-start='1500'
                                            data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                            data-elementdelay='0.1' data-endelementdelay='0.1'
                    ...
                    <div class="jtv-dis-bar">
                        ...
                        <ul class="jtv-social-icons text-left text-md-right pt-2">
                            <li class="jtv-social_facebook"><a href="#" target="_blank" class=""><i
                                        class="fa fa-facebook"></i></a></li>
                            <li class="jtv-social_twitter"><a href="#" target="_blank" class=""><i
                                        class="fa fa-twitter"></i></a></li>
                            <li class="jtv-social_google"><a href="#" target="_blank" class=""><i
                                        class="fa fa-google-plus"></i></a></li>
                            <li class="jtv-social_email"><a href="#" target="_blank" class=""><i
                                        class="fa fa-envelope"></i></a></li>
                            <li class="jtv-social_pinterest"><a href="#" target="_blank" class=""><i
            ...
            <div class="container">
                <div class="row">
                                                ...
                                                <div class="item-inner">
                                                    <div class="item-img">
                                                        <div class="item-img-info"><a class="product-image"
                                                                ...
                                                                href="product-detail.html"> <img
                                                                    alt="Product tilte is here"
                                                                    src="/assets/client/images/products/product-fashion-1.jpg">
                                                            </a>
                                                            <div class="new-label new-top-left">new</div>
                                                            <div class="mask-shop-white"></div>
                                                            <a class="quickview-btn" href="quick-view.html"><span>Quick
                                                                    View</span></a> <a href="wishlist.html">
                                                                <div class="mask-left-shop"><i class="fa fa-heart"></i>
                                                                </div>
                                                            </a> <a href="compare.html">
                                                                <div class="mask-right-shop"><i
                                                    ...
                                                    <div class="item-info">
                                                        <div class="info-inner">
                                                            <div class="item-title"> <a title="Product tilte is here"
                                                                    href="product-detail.html">Product tilte is here
                                                                </a> </div>
                                    ...
                                    <div class="slider-items slider-width-col4 products-grid">
                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"><a class="product-image"
                                                            title="Product tilte is here" href="product-detail.html">
                                                            <img alt="Product tilte is here"
                                                                src="/assets/client/images/products/product-fashion-1.jpg">
                                                        </a>
                                                        <div class="new-label new-top-left">new</div>
                                                        <div class="mask-shop-white"></div>
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"> <span class="regular-price">
                                                                        <span class="price">$222.79</span></span>
                                                                    <p class="old-price"> <span
                                                                            class="price-label">Regular Price:</span>
                                                                        <span class="price"> $269.00 </span> </p>
                                                                </div>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"> <span class="regular-price">
                                                                        <span class="price">$325.00</span></span></div>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                                    <button class="button btn-cart"
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"> <span class="regular-price">
                                                                        <span class="price">$199.00</span></span></div>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                                    <button class="button btn-cart"
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"> <span class="regular-price">
                                                                        <span class="price">$149.00</span></span></div>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                                    <button class="button btn-cart"
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"> <span class="regular-price">
                                                                        <span class="price">$189.00</span></span></div>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                                    <button class="button btn-cart"
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"> <span class="regular-price">
                                                                        <span class="price">$219.00</span></span></div>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                                    <button class="button btn-cart"
                                ...
                                <div class="blog-outer-container">
                                    <div class="blog-inner">
                                        <div class="col-xs-12 col-sm-6 blog-preview_item">
                                            <div class="entry-thumb jtv-blog-img-hover"> <a
                                                    href="blog_single_post.html"> <img alt="Blog"
                                                        src="/assets/client/images/blog-img1.jpg"> </a> </div>
                                            <h4 class="blog-preview_title"><a href="blog_single_post.html">Neque porro
                                                    quisquam est qui</a></h4>
                                            <div class="blog-preview_info">
                                                ...
                                                <div class="blog-preview_desc">Lorem Ipsum is simply dummy text of the
                                                    printing and typesetting industry. <a class="read_btn"
                                                        href="blog_single_post.html">Read More</a></div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 blog-preview_item">
                                            <div class="entry-thumb jtv-blog-img-hover"> <a
                                                    href="blog_single_post.html"> <img alt="Blog"
                                                        src="/assets/client/images/blog-img1.jpg"> </a> </div>
                                            <h4 class="blog-preview_title"><a href="blog_single_post.html">Dolorem ipsum
                                                    quia dolor sit amet</a></h4>
                                            <div class="blog-preview_info">
                                                <ul class="post-meta">
                                                    <li><i class="fa fa-user"></i>By <a href="#">admin</a></li>
                                                    <li><i class="fa fa-comments"></i><a href="#">8 comments</a></li>
                                                    <li><i class="fa fa-clock-o"></i><span class="day">15</span><span
                                                            class="month">Jan</span></li>
                                                </ul>
                                                <div class="blog-preview_desc">Sed ut perspiciatis unde omnis iste natus
                                                    error sit voluptatem dolore lauda. <a class="read_btn"
                                                        href="blog_single_post.html">Read More</a></div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-left sidebar col-sm-4 col-xs-12 col-sm-pull-8 col-md-3 col-md-pull-9">
                        <div class="jtv-hot-deal-product">
                            <ul class="products-grid">
                                <li class="right-space two-height item">
                                    <div class="item-inner">
                                        <div class="item-img">
                                            <div class="item-img-info"><a href="#" title="Product tilte is here"
                                                    class="product-image"><img
                                                        src="/assets/client/images/products/product-fashion-1.jpg"
                                                        alt="Product tilte is here"> </a>
                                        ...
                                        <div class="item-info">
                                            <div class="info-inner">
                                                <div class="item-title"> <a title="Product tilte is here"
                                                        href="product-detail.html">Product tilte is here </a> </div>
                                                <div class="item-content">
                                                    <div class="rating"> <i class="fa fa-star"></i> <i
                        ...
                        <div class="sidebar-banner"><img src="/assets/client/images/new-arrivals-banner.jpg"
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box"> <span class="regular-price">
                                                                        <span class="price">$125.00</span></span></div>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="add_cart">
                                                                    <button class="button btn-cart"
                                                            ...
                                                            <div class="item-price">
                                                                <div class="price-box">
                                                                    <p class="special-price"> <span
                                                                            ...
                                                                            Price</span><span class="price"> $156.00
                                                                        </span></p>
                                                                    <p class="old-price"> <span
                                                                            class="price-label">Regular
        ...
        <div class="jtv-collection-area">
            <div class="container">
                <div class="column-right pull-left col-sm-4 no-padding"> <a href="#"> <img
                            src="/assets/client/images/women-top.jpg" alt="Top Collections"> </a>
                ...
                <div class="column-left pull-right col-sm-8 no-padding">
                    <div class="column-left-top">
                        <div class="col-left-top-left pull-left col-sm-8 no-padding"> <a href="#"> <img
                                    src="/assets/client/images/men-suits.jpg" alt="Men's Suits"> </a>
                        ...
                        <div class="col-left-top-right pull-right col-sm-4 no-padding"> <a href="#"> <img
                                    src="/assets/client/images/footwear.jpg" alt="footwear"> </a>
                    ...
                    <div class="column-left-bottom col-sm-12 no-padding">
                        <div class="col-left-bottom-left pull-left col-sm-4 no-padding"> <a href="#"> <img
                                    src="/assets/client/images/handbag.jpg" alt="Handbag"> </a>
                        ...
                        <div class="col-left-bottom-right pull-right col-sm-8 no-padding"> <a href="#"> <img
                                    src="/assets/client/images/watch-banner.jpg" alt="Watch"> </a>
                ...
                <div class="slider-items-products">
                    <div id="jtv-brand-logo-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col6">
                            <div class="item"><a href="#"><img src="/assets/client/images/brand1.png"
                                        alt="Brand Logo"></a> </div>
                            <div class="item"><a href="#"><img src="/assets/client/images/brand2.png"
                                        alt="Brand Logo"></a> </div>
                            <div class="item"><a href="#"><img src="/assets/client/images/brand3.png"
                                        alt="Brand Logo"></a> </div>
                            <div class="item"><a href="#"><img src="/assets/client/images/brand4.png"
                                        alt="Brand Logo"></a> </div>
                            <div class="item"><a href="#"><img src="/assets/client/images/brand5.png"
                                        alt="Brand Logo"></a> </div>
                            <div class="item"><a href="#"><img src="/assets/client/images/brand6.png"
                                        alt="Brand Logo"></a> </div>
                            <div class="item"><a href="#"><img src="/assets/client/images/brand7.png"
                                        alt="Brand Logo"></a> </div>
                            <div class="item"><a href="#"><img src="/assets/client/images/brand8.png"
                                        alt="Brand Logo"></a> </div>
                        </div>
                    </div>
                </div>
        ...
        <footer>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="payment-accept">
                                ...
                                <div class="payment-icon"><img src="/assets/client/images/paypal.png" alt="paypal"> <img
                                        src="/assets/client/images/visa.png" alt="visa"> <img
                                        src="/assets/client/images/american-exp.png" alt="american express"> <img
                                        src="/assets/client/images/mastercard.png" alt="mastercard"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 coppyright text-center">© 2018 Glorious, All rights reserved.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="/assets/client/js/revslider.js"></script>
    <script src="/assets/client/js/main.js"></script>
    <script src="/assets/client/js/owl.carousel.min.js"></script>
    <script src="/assets/client/js/mob-menu.js"></script>
